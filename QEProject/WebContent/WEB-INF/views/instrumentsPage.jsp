...
<h1>Items currently for sell!</h1>

 <div class="container">
  <div class="row">
<%ArrayList<Items> allItems = (ArrayList<Items>)request.getAttribute("someInv");%>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    <h5 class="card-title"><%=s.getItemDescription() %></h5>
    <p class="card-text">Price: $<%=s.getItemPrice() %></p>
    <a href="${pageContext.request.contextPath}/HomeServlet/showDetailsIntrument?id=<%=s.getItemID()%>" class="btn btn-primary">Details</a>
  </div>
</div>
