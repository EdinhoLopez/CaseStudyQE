...
<%@page import="java.util.ArrayList,javaModels.Category" %>
...
<h1>Pick a category to browser</h1>

 <div class="container">
  <div class="row">


<%ArrayList<Category> allCategory = (ArrayList<Category>)request.getAttribute("allCategory");

for (Category s : allCategory) {%>

<div class="card" style="width: 18rem;">
  <img src="${pageContext.request.contextPath}/Images//lessonsPictureOne.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title"><%=s.getCategoryName() %></h5>
    <p class="card-text"><%=s.getCategoryDescription() %></p>
    <a href="${pageContext.request.contextPath}/HomeServlet/showInstrumentsPage?id=<%=s.getCategoryID()%>" class="btn btn-primary">Browser</a>
  </div>
</div>
