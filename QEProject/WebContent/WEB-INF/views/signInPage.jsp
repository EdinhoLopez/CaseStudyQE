...
<p>Username: <input type="text" name="usernameSignIn"></p>

<p>Password: <input type="text" name="passwordSignIn"></p>
</br>
<input type="submit" name="logIn">

</form>

<h3>Don't have an account? <a href="${pageContext.request.contextPath}/HomeServlet/register">Register Here!</a></h3>
